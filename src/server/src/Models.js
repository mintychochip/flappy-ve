...
class MatchResult {
   ...
   * @param {number} score
   */
  constructor(id, matchId, userId, score) {
    this.id = id;
...
class GameObject {
  ...
  collides(obj2) {
    ...
    const horizontalCollision =
      Math.abs(this.position.x - obj2.position.x) < halfWidth1 + halfWidth2;
    const verticalCollision =
      Math.abs(this.position.y - obj2.position.y) < halfHeight1 + halfHeight2;
